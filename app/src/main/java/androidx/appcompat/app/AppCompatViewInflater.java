...
public class AppCompatViewInflater {
    ...
    private static class View$OnClickListenerC0427a implements android.view.View.OnClickListener {
        ...
        public void onClick(android.view.View r5) {
                ...
                r4.m2661a(r0, r1)
            L_0x000f:
                java.lang.reflect.Method r0 = r4.f1391d     // Catch: IllegalAccessException -> 0x0026, InvocationTargetException -> 0x001d
                android.content.Context r1 = r4.f1392e     // Catch: IllegalAccessException -> 0x0026, InvocationTargetException -> 0x001d
                r2 = 1
                java.lang.Object[] r2 = new java.lang.Object[r2]     // Catch: IllegalAccessException -> 0x0026, InvocationTargetException -> 0x001d
                r3 = 0
                r2[r3] = r5     // Catch: IllegalAccessException -> 0x0026, InvocationTargetException -> 0x001d
                r0.invoke(r1, r2)     // Catch: IllegalAccessException -> 0x0026, InvocationTargetException -> 0x001d
                return
            L_0x001d:
                r5 = move-exception
    ...
    private android.view.View createViewFromTag(android.content.Context r5, java.lang.String r6, android.util.AttributeSet r7) {
        ...
        L_0x000f:
            r0 = 1
            r2 = 0
            java.lang.Object[] r3 = r4.mConstructorArgs     // Catch: Exception -> 0x0056, all -> 0x004e
            r3[r2] = r5     // Catch: Exception -> 0x0056, all -> 0x004e
            java.lang.Object[] r3 = r4.mConstructorArgs     // Catch: Exception -> 0x0056, all -> 0x004e
            r3[r0] = r7     // Catch: Exception -> 0x0056, all -> 0x004e
            r7 = -1
            r3 = 46
            int r3 = r6.indexOf(r3)     // Catch: Exception -> 0x0056, all -> 0x004e
            if (r7 != r3) goto L_0x0043
            r7 = 0
        L_0x0023:
            java.lang.String[] r3 = androidx.appcompat.app.AppCompatViewInflater.sClassPrefixList     // Catch: Exception -> 0x0056, all -> 0x004e
            int r3 = r3.length     // Catch: Exception -> 0x0056, all -> 0x004e
            if (r7 >= r3) goto L_0x003c
            java.lang.String[] r3 = androidx.appcompat.app.AppCompatViewInflater.sClassPrefixList     // Catch: Exception -> 0x0056, all -> 0x004e
            r3 = r3[r7]     // Catch: Exception -> 0x0056, all -> 0x004e
            android.view.View r3 = r4.createViewByPrefix(r5, r6, r3)     // Catch: Exception -> 0x0056, all -> 0x004e
        ...
        L_0x003c:
            ...
            return r1
        L_0x0043:
            android.view.View r5 = r4.createViewByPrefix(r5, r6, r1)     // Catch: Exception -> 0x0056, all -> 0x004e
