...
public class C0751j {
    ...
    private static androidx.lifecycle.AbstractC0740c m1364a(java.lang.reflect.Constructor<? extends androidx.lifecycle.AbstractC0740c> r2, java.lang.Object r3) {
            r0 = 1
            java.lang.Object[] r0 = new java.lang.Object[r0]     // Catch: IllegalAccessException -> 0x001b, InstantiationException -> 0x0014, InvocationTargetException -> 0x000d
            r1 = 0
            r0[r1] = r3     // Catch: IllegalAccessException -> 0x001b, InstantiationException -> 0x0014, InvocationTargetException -> 0x000d
            java.lang.Object r2 = r2.newInstance(r0)     // Catch: IllegalAccessException -> 0x001b, InstantiationException -> 0x0014, InvocationTargetException -> 0x000d
            androidx.lifecycle.c r2 = (androidx.lifecycle.AbstractC0740c) r2     // Catch: IllegalAccessException -> 0x001b, InstantiationException -> 0x0014, InvocationTargetException -> 0x000d
            return r2
        L_0x000d:
            r2 = move-exception
    ...
    private static java.lang.reflect.Constructor<? extends androidx.lifecycle.AbstractC0740c> m1367a(java.lang.Class<?> r4) {
            java.lang.Package r0 = r4.getPackage()     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            java.lang.String r1 = r4.getCanonicalName()     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            if (r0 == 0) goto L_0x000f
            java.lang.String r0 = r0.getName()     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            goto L_0x0011
        L_0x000f:
            java.lang.String r0 = ""
        L_0x0011:
            boolean r2 = r0.isEmpty()     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            r3 = 1
            if (r2 == 0) goto L_0x0019
            goto L_0x0022
        L_0x0019:
            int r2 = r0.length()     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            int r2 = r2 + r3
            java.lang.String r1 = r1.substring(r2)     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
        L_0x0022:
            java.lang.String r1 = m1365a(r1)     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            boolean r2 = r0.isEmpty()     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            if (r2 == 0) goto L_0x002d
            goto L_0x0041
        L_0x002d:
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            ...
            java.lang.String r1 = r2.toString()     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
        L_0x0041:
            java.lang.Class r0 = java.lang.Class.forName(r1)     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            java.lang.Class[] r1 = new java.lang.Class[r3]     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            r2 = 0
            r1[r2] = r4     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            java.lang.reflect.Constructor r4 = r0.getDeclaredConstructor(r1)     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
            boolean r0 = r4.isAccessible()     // Catch: ClassNotFoundException -> 0x005f, NoSuchMethodException -> 0x0058
