...
public class C0036g extends android.view.MenuInflater {
    ...
    public void inflate(int r4, android.view.Menu r5) {
        ...
        L_0x000a:
            r1 = 0
            android.content.Context r2 = r3.f110c     // Catch: XmlPullParserException -> 0x002b, IOException -> 0x0024, all -> 0x0022
            ...
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r1)     // Catch: XmlPullParserException -> 0x002b, IOException -> 0x0024, all -> 0x0022
            r3.m4167a(r1, r4, r5)     // Catch: XmlPullParserException -> 0x002b, IOException -> 0x0024, all -> 0x0022
