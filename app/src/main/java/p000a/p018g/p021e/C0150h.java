...
class C0150h {
    ...
    public android.graphics.Typeface mo3626a(android.content.Context r1, android.content.res.Resources r2, int r3, java.lang.String r4, int r5) {
            ...
            return r4
        L_0x0008:
            boolean r2 = p000a.p018g.p021e.C0154i.m3610a(r1, r2, r3)     // Catch: RuntimeException -> 0x0023, all -> 0x001e
            if (r2 != 0) goto L_0x0012
            r1.delete()
            return r4
        L_0x0012:
            java.lang.String r2 = r1.getPath()     // Catch: RuntimeException -> 0x0023, all -> 0x001e
            android.graphics.Typeface r2 = android.graphics.Typeface.createFromFile(r2)     // Catch: RuntimeException -> 0x0023, all -> 0x001e
            r1.delete()
            return r2
        L_0x001e:
            r2 = move-exception
    ...
    public android.graphics.Typeface mo3625a(android.content.Context r3, android.os.CancellationSignal r4, p000a.p018g.p026i.C0161b.C0167f[] r5, int r6) {
        ...
        L_0x0006:
            ...
            android.content.ContentResolver r5 = r3.getContentResolver()     // Catch: IOException -> 0x0026, all -> 0x0021
            android.net.Uri r4 = r4.m3583c()     // Catch: IOException -> 0x0026, all -> 0x0021
            java.io.InputStream r4 = r5.openInputStream(r4)     // Catch: IOException -> 0x0026, all -> 0x0021
            android.graphics.Typeface r3 = r2.m3624a(r3, r4)     // Catch: IOException -> 0x0027, all -> 0x001e
    ...
    protected android.graphics.Typeface m3624a(android.content.Context r2, java.io.InputStream r3) {
            ...
            return r0
        L_0x0008:
            boolean r3 = p000a.p018g.p021e.C0154i.m3609a(r2, r3)     // Catch: RuntimeException -> 0x0023, all -> 0x001e
            if (r3 != 0) goto L_0x0012
            r2.delete()
            return r0
        L_0x0012:
            java.lang.String r3 = r2.getPath()     // Catch: RuntimeException -> 0x0023, all -> 0x001e
            android.graphics.Typeface r3 = android.graphics.Typeface.createFromFile(r3)     // Catch: RuntimeException -> 0x0023, all -> 0x001e
            r2.delete()
            return r3
        L_0x001e:
            r3 = move-exception
