...
public class C0398d {
    ...
    public static android.view.animation.Interpolator m2756a(android.content.Context r4, int r5) {
        ...
        L_0x000b:
            ...
            a.k.a.a.a r4 = new a.k.a.a.a     // Catch: XmlPullParserException -> 0x001d, IOException -> 0x001b, all -> 0x0019
            r4.<init>()     // Catch: XmlPullParserException -> 0x001d, IOException -> 0x001b, all -> 0x0019
            return r4
        L_0x0019:
            r4 = move-exception
            goto L_0x0087
        ...
        L_0x001f:
            ...
            a.k.a.a.b r4 = new a.k.a.a.b     // Catch: XmlPullParserException -> 0x001d, IOException -> 0x001b, all -> 0x0019
            r4.<init>()     // Catch: XmlPullParserException -> 0x001d, IOException -> 0x001b, all -> 0x0019
            return r4
        L_0x002a:
            r1 = 17563662(0x10c000e, float:2.5713978E-38)
            if (r5 != r1) goto L_0x0035
            a.k.a.a.c r4 = new a.k.a.a.c     // Catch: XmlPullParserException -> 0x001d, IOException -> 0x001b, all -> 0x0019
            r4.<init>()     // Catch: XmlPullParserException -> 0x001d, IOException -> 0x001b, all -> 0x0019
            return r4
        L_0x0035:
            android.content.res.Resources r1 = r4.getResources()     // Catch: XmlPullParserException -> 0x001d, IOException -> 0x001b, all -> 0x0019
            android.content.res.XmlResourceParser r0 = r1.getAnimation(r5)     // Catch: XmlPullParserException -> 0x001d, IOException -> 0x001b, all -> 0x0019
            android.content.res.Resources r1 = r4.getResources()     // Catch: XmlPullParserException -> 0x001d, IOException -> 0x001b, all -> 0x0019
            android.content.res.Resources$Theme r3 = r4.getTheme()     // Catch: XmlPullParserException -> 0x001d, IOException -> 0x001b, all -> 0x0019
            android.view.animation.Interpolator r4 = m2755a(r4, r1, r3, r0)     // Catch: XmlPullParserException -> 0x001d, IOException -> 0x001b, all -> 0x0019
