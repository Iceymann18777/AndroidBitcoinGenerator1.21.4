...
public class C0399e {
    ...
    public static android.animation.Animator m2748a(android.content.Context r2, android.content.res.Resources r3, android.content.res.Resources.Theme r4, int r5, float r6) {
            ...
            r1 = 0
            android.content.res.XmlResourceParser r1 = r3.getAnimation(r5)     // Catch: XmlPullParserException -> 0x0030, IOException -> 0x0013, all -> 0x0011
            android.animation.Animator r2 = m2744a(r2, r3, r4, r1, r6)     // Catch: XmlPullParserException -> 0x0030, IOException -> 0x0013, all -> 0x0011
